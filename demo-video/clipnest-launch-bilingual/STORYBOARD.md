...
## BEAT 3 — 理解表单，6.20–13.20s

**VO:** “它理解你正在填写什么，并把最合适的内容，送到指尖。”

**Concept:** 邮箱、个人主页和手机号三个字段依次获得焦点。相关候选优先出现，邮箱逐字填入，主页唯一匹配直接填入，手机号使用掩码内容完成演示。
